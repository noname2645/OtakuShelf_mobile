...
const styles = StyleSheet.create({
  ...
  heroContent: {
    position: 'absolute', bottom: 48, left: 18, right: 18,
  },
  heroGenres: { color: '#ddd', fontSize: 12, fontWeight: '600', letterSpacing: 1.2, marginBottom: 8, textTransform: 'uppercase' },
  heroTitle: {
    fontSize: 28, fontWeight: '800', color: '#fff', fontFamily: 'OutfitRegular',
  ...
  heroDesc: {
    color: '#ffffff', fontSize: 13, lineHeight: 20, marginBottom: 16,
    fontFamily: 'JosefinSans',
    textShadowColor: 'rgba(0,0,0,0.8)', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 4,
  },
  heroBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: '#ff6b6b', paddingHorizontal: 22, paddingVertical: 12,
    borderRadius: 24, alignSelf: 'flex-start',
    shadowColor: '#ff6b6b', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.5, shadowRadius: 10, elevation: 8,
  },
